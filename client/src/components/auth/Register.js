      ...
      <div className="max-w-md w-full space-y-8">
        <div className="text-center">
          ...
          <p className="mt-2 text-center text-sm text-gray-400">
            Join ProjectFlow to start managing your projects
          </p>
        </div>
            ...
            <div className="space-y-4">
              <div>
                ...
                <input
                  ...
                  className={`appearance-none block w-full px-4 py-3 border ${
                    errors.name ? 'border-red-500' : 'border-[#2D2D44]'
              ...
              <div>
                ...
                <input
                  ...
                  onChange={onChange}
                  className={`appearance-none block w-full px-4 py-3 border ${
                    errors.password2 ? 'border-red-500' : 'border-[#2D2D44]'
                  } placeholder-gray-400 text-white bg-[#14141D] rounded-lg focus:outline-none focus:ring-2 focus:ring-[#4A90E2] focus:border-[#4A90E2] sm:text-sm`}
                  placeholder="••••••••"
                />
                {errors.password2 && (
        ...
        <div className="text-center">
          <p className="text-sm text-gray-400">
            ...
            <Link to="/login" className="font-medium text-[#4A90E2] hover:text-[#50E3C2] transition-colors duration-200">
              Sign in
            </Link>
          </p>
        </div>
